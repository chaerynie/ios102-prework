...
- [ ] 2. User can select on additional buttons that provide more info about the user (favorite color)
- [ ] 3. Any stylistic changes that are not default options (font, layout)
